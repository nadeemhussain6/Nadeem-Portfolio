export const Bio = {
  ...
  description:
    "A dedicated Data Analyst and BI Developer with extensive experience in data analysis, data visualization, and expert-level proficiency in building dashboards using Excel, Power BI, Tableau, and Lumenore.",
  github: "https://github.com/nadeemhussain6",
  resume: "",
  // "https://drive.google.com/file/d/1ffZrcMcn8UatXGIaautbbqpV7ADNaETA/view?usp=sharing",
  linkedin:
    "https://www.linkedin.com/in/nadeemhussain5765/?utm_source=share&utm_campaign=share_via&utm_content=profile&utm_medium=android_app",
...
export const experiences = [
  {
    id: 0,
    img: "https://media.licdn.com/dms/image/v2/D4D0BAQGvywu6HYLuvA/company-logo_200_200/company-logo_200_200/0/1709625643415/netlinksolutions_logo?e=2147483647&v=beta&t=Cz2O1Pnm69iXiup3QRNVorPaXnd6a4d3QU6ZhuBWsjk",
    role: "Marketing Intern",
    company: "Netlink Software Group America",
    date: "Feb 2024 - Present, Bhopal (M.P)",
    desc: "As a Marketing Intern at Netlink Software Group America Inc., I manage and process data, generate leads with tools like LinkedIn Sales Navigator, Apollo.io, and Draup, and conduct secondary research on companies. I also clean and visualize data using Lumenore, Netlink's proprietary tool, to create interactive dashboards for events like the Snowflake and Informatica Data Summit. Additionally, I contribute to the NHM project by developing dashboards and storyboards, and preparing reports to assist higher authorities in decision-making.",
    skills: [
  ...
  {
    id: 0,
    img: "https://encrypted-tbn0.gstatic.com/images?q=tbn:ANd9GcQbRWFMWR0ZVJByGadksSMu-4evEfgQfORMEg&s",
    role: "Data Analyst Intern",
    company: "Coding Ninjas",
    date: "March 2023 - March 2024, Remote",
    desc: "Developed interactive dashboards to visualize and analyze data, resulting in a 20% increase in data accessibility and improved decision-making process. Identified and fixed a critical issue with the Doubts table, resulting in 80% reduction in data discrepancy through close collaboration with cross-functional teams. Utilized advanced SQL techniques, including list aggregation functions, to streamline data aggregation processes, leading to a 15% improvement in data processing speed and accuracy.",
    skills: [
      "SQL",
      "Microsoft excel",
      "Microsoft Power BI",
  ...
  {
    id: 1,
    img: "https://encrypted-tbn0.gstatic.com/images?q=tbn:ANd9GcQLVb4HPHZdCMjKl_FiZIaiSEVLSSGnBzt5Xw&s",
    role: "Data Analyst Intern",
    company: "IIT ROORKE",
    date: "June 2023 – July 2023, Remote",
    desc: "As a Data Analyst intern at IIT ROORKE, I create interactive dashboards using Excel and Tableau. My responsibilities include working with SQL for table creation, data management, and performing data operations such as insert, retrieve, and delete. Additionally, I utilize Python, machine learning, and statistics for comprehensive data analysis.",
    skills: [
      "ETL",
      "DAX",
      " SQL",
  ...
  },
  {
    ...
    company: "ACCENTURE",
    date: "Nov 2022 – Dec 2022, Remote",
    desc: "Revolutionized reporting with complex dashboards, saving 120+ monthly hours. Resolved data discrepancies, ensuring accurate reporting and forecasting. Built data driven infrastructure with Data Studio forreal-time insights on abuse alerts by region. Achieved 80% team efficiency boost and halved response time.",
    skills: [
      "Microsoft Power BI",
      "Microsoft excel",
      "Storytelling",
  ...
  {
    id: 3,
    img: "https://encrypted-tbn0.gstatic.com/images?q=tbn:ANd9GcTnKjLMuLfRgVuQXRYcpzcCIZ2P_4fwVACewQ&s",
    role: "Radio Frequency Engineer",
    company: "AMDOCS",
    date: "Jan 2022 – Nov 2022, Pune, Maharashtra",
    desc: "Designed and optimized RF network configurations to ensure seamless communication and minimize interference. Conducted RF site surveys and analyzed data to identify coverage gaps and recommend solutions for network enhancement. Collaborated with cross-functional teams to plan and implement RF network expansions and upgrades.",
    skills: [
      "ARAMIS",
      " FTTX",
      "Communication",
...
export const education = [
  {
    id: 0,
    img: "https://encrypted-tbn0.gstatic.com/images?q=tbn:ANd9GcTaAE6k9CXhP9heuK_jo-Zj0Lbj_oWs1O0ZHg&s",
    school: "SAGE University, Bhopal (M.P)",
    ...
    degree:
      "Master Of Business Administration in Data Analytics with Marketing",
  },
  {
    id: 1,
    img: "https://encrypted-tbn0.gstatic.com/images?q=tbn:ANd9GcTr_VY5D-EwnfopmtjwUei2NaWCZkSiZ9xk4A&s",
    school: "LNCT Group of Colleges, Bhopal (M.P)",
    date: "January 2019 - July 2021",
    grade: "88.2%",
    desc: "I completed my class 12 high school education at Methodist School, Dankuni, where I studied Science with Computer Science.",
    degree: "Bachelor Of Technology in Electrical Engineering (EE)",
  },
  {
    id: 2,
    img: "https://upload.wikimedia.org/wikipedia/en/6/61/Rajiv_Gandhi_Technical_University_logo.jpg",
    school: "University Institute of Technology, RGPV",
    date: "January 2016 - December 2018",
    grade: "92.3%",
    desc: "I completed my class 10 education at Methodist School, Dankuni, where I studied Science with Computer Application.",
    degree: "Diploma of Education in Electrical Engineering (EE)",
  },
];
